...
namespace RS1_Ispit_asp.net_core.Migrations
{
    ...
    [Migration("20200117150531_Komisije")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RS1_Ispit_asp.net_core.EntityModels.PopravniIspit", b =>
                {
                    ...
                    b.Property<int>("Komisija1Id");

                    b.Property<int>("Komisija2Id");

                    b.Property<int>("Komisija3Id");
                    ...
                    b.HasIndex("Komisija1Id");

                    b.HasIndex("Komisija2Id");

                    b.HasIndex("Komisija3Id");
            ...
            modelBuilder.Entity("RS1_Ispit_asp.net_core.EntityModels.PopravniIspitUcenik", b =>
                {
                    ...
                    b.Property<int>("RezultatPopravnogIspita");
            ...
            modelBuilder.Entity("RS1_Ispit_asp.net_core.EntityModels.PopravniIspit", b =>
                {
                    b.HasOne("RS1_Ispit_asp.net_core.EntityModels.Nastavnik", "Komisija1")
                        .WithMany()
                        .HasForeignKey("Komisija1Id")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("RS1_Ispit_asp.net_core.EntityModels.Nastavnik", "Komisija2")
                        .WithMany()
                        .HasForeignKey("Komisija2Id")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("RS1_Ispit_asp.net_core.EntityModels.Nastavnik", "Komisija3")
                        .WithMany()
                        .HasForeignKey("Komisija3Id")
                        .OnDelete(DeleteBehavior.Cascade);
