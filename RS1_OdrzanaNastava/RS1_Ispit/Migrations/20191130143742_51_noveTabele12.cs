...
{
    public partial class _51_noveTabele12 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PoravniIspitUcenik",
                columns: table => new
                {
                    PoravniIspitUcenikId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    OdjeljenjeStavkaId = table.Column<int>(nullable: false),
                    PopravniIspitId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PoravniIspitUcenik", x => x.PoravniIspitUcenikId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PoravniIspitUcenik_PopravniIspit_PopravniIspitId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PoravniIspitUcenik_PopravniIspitId",
                table: "PoravniIspitUcenik",
